                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Otras prestaciones sociales',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          font: GoogleFonts.notoSansJp(
                                    ...
                                    hintText: 'Otras prestaciones sociales',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          font: GoogleFonts.notoSansJp(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (!widget.edit!) {
                                            await Seccion4Table().insert({
                                              ...
                                              'tarjeta': _model
                                                  .radioButtonTarjetaValue,
                                              'pension': _model
                                                  .radioButtonPensionValue,
                                            ...
                                            await Seccion4Table().update(
                                              data: {
                                                ...
                                                'idExpediente':
                                                    widget.idexpediente,
                                                'paicor': _model
                                                    .radioButtonPaicorValue,
                                                'auh':
                                                    _model.radioButtonAUHValue,
                                                'tarjeta': _model
                                                    .radioButtonTarjetaValue,
                                                'pension': _model
                                                    .radioButtonPensionValue,
                                        ...
                                        onPressed: () async {
                                          ...
                                          _model.seccion4 =
                                            ...
                                            queryFn: (q) => q.eqOrNull(
                                              'idIngreso',
                                              _model.expedienteprincipal
                                                  ?.firstOrNull?.idIngreso,
                                            ),
                                          );
                                          await Seccion4Table().insert({
                                            'cualPen': _model
                                                .seccion4?.firstOrNull?.cualPen,
                                            'otros': _model
                                                .seccion4?.firstOrNull?.otros,
                                            'actividad': _model.seccion4
                                                ?.firstOrNull?.actividad,
                                            'agua': _model
                                                .seccion4?.firstOrNull?.agua,
                                            'aguaObs': _model
                                                .seccion4?.firstOrNull?.aguaObs,
                                            'cloacas': _model
                                                .seccion4?.firstOrNull?.cloacas,
                                            'cloacasObs': _model.seccion4
                                                ?.firstOrNull?.cloacasObs,
                                            'gas': _model
                                                .seccion4?.firstOrNull?.gas,
                                            'gasObs': _model
                                                .seccion4?.firstOrNull?.gasObs,
                                            'electricidad': _model.seccion4
                                                ?.firstOrNull?.electricidad,
                                            'electricidadObs': _model.seccion4
                                                ?.firstOrNull?.electricidadObs,
                                            'internet': _model.seccion4
                                                ?.firstOrNull?.internet,
                                            'internetObs': _model.seccion4
                                                ?.firstOrNull?.internetObs,
                                            'paa': _model
                                                .seccion4?.firstOrNull?.paa,
                                            'paaObs': _model
                                                .seccion4?.firstOrNull?.paaObs,
                                            'pmv': _model
                                                .seccion4?.firstOrNull?.pmv,
                                            'pmvObs': _model
                                                .seccion4?.firstOrNull?.pmvObs,
                                            'ssp': _model
                                                .seccion4?.firstOrNull?.ssp,
                                            'sspObs': _model
                                                .seccion4?.firstOrNull?.sspObs,
                                            'idIngreso': widget.idingreso,
                                            'idExpediente':
                                                widget.idexpediente,
                                            'paicor': _model
                                                .seccion4?.firstOrNull?.paicor,
                                            'auh': _model
                                                .seccion4?.firstOrNull?.auh,
                                            'tarjeta': _model
                                                .seccion4?.firstOrNull?.tarjeta,
                                            'pension': _model
                                                .seccion4?.firstOrNull?.pension,
                                            'iduser': currentUserUid,
                                          });
                                          await IngresosTable().update(
                                            data: {
