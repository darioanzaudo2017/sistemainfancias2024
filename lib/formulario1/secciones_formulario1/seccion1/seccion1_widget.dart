...
class _Seccion1WidgetState extends State<Seccion1Widget> {
  ...
  void initState() {
    ...
    _model.textFieldbarrioFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Seccion1Row>>(
      ...
      builder: (context, snapshot) {
        ...
        List<Seccion1Row> stackSeccion1RowList = snapshot.data!;

        final stackSeccion1Row =
            stackSeccion1RowList.isNotEmpty ? stackSeccion1RowList.first : null;
        ...
        return Stack(
          children: [
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                                              ...
                                              if (_model.dropDownbarrioValue ==
                                                ...
                                                Expanded(
                                                  child: Padding(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                              .textFieldbarrioTextController ??=
                                                          TextEditingController(
                                                        text: stackSeccion1Row
                                                            ?.barrioOtro,
                                                      ),
                                                      focusNode: _model
                                                          .textFieldbarrioFocusNode,
                                                      autofocus: true,
                                                      obscureText: false,
                                                      decoration:
                                                          InputDecoration(
                              ...
                              FutureBuilder<List<TIntitucionesSaludRow>>(
                                future: (_model.requestCompleter ??=
                                        Completer<List<TIntitucionesSaludRow>>()
                                          ..complete(TIntitucionesSaludTable()
                                              .queryRows(
                                            queryFn: (q) => q.eqOrNull(
                                              'idIngreso',
                                              widget.idingreso2,
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<TIntitucionesSaludRow>
                                      containersaludTIntitucionesSaludRowList =
                                      snapshot.data!;
                                                  ...
                                                  return SingleChildScrollView(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: List.generate(
                                                          listainstituciones
                                                              .length,
                                                          (listainstitucionesIndex) {
                                                        final listainstitucionesItem =
                                                            listainstituciones[
                                                                listainstitucionesIndex];
                                                        return Container(
                                                          decoration:
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  'Num Historia Clinica: ${listainstitucionesItem.nunHisClinica?.toString()}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            var confirmDialogResponse = await showDialog<bool>(
                                                                                  ...
                                                                                  builder: (alertDialogContext) {
                                                                                    return WebViewAware(
                                                                                      child: AlertDialog(
                                                                                        title: Text('Desear eliminar?'),
                                                                                        content: Text('Vas a eliminar el centro y numero de historia clinica!'),
                                                                                        actions: [
                                                                                          TextButton(
                                                                            ...
                                                                            if (confirmDialogResponse) {
                                                                              await TIntitucionesSaludTable().delete(
                                                                                matchingRows: (rows) => rows.eqOrNull(
                                                                                  'id',
                                                                                  listainstitucionesItem.id,
                                                                                ),
                                                                              );
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: FlutterFlowRadioButton(
                                                    ...
                                                    onChanged: (val) =>
                                                        safeSetState(() {}),
                                                    controller: _model
                                                            .radioButtoedunocorrespondeValueController ??=
                                                        FormFieldController<
                                                                String>(
                                                            valueOrDefault<
                                                                String>(
                                          ...
                                          if (_model
                                                  .radioButtoedunocorrespondeValue ==
                                              'Si')
                                            Row(
                                              mainAxisSize: MainAxisSize.max,
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: FlutterFlowRadioButton(
                                                    ...
                                                    onChanged: (val) =>
                                                        safeSetState(() {}),
                                                    controller: _model
                                                            .radioButtonconcurreescuelaValueController ??=
                                                        FormFieldController<
                                                                String>(
                                                            valueOrDefault<
                                                                String>(
                                      ...
                                      if (_model
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            if (_model
                                                    .radioButtonconcurreescuelaValue ==
                                                'No')
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
            ...
            if ((_model.editarseccion1 == true) &&
                (stackSeccion1Row?.idSec1 != null))
              Container(
