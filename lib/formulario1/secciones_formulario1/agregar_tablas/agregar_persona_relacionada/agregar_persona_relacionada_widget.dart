...
import 'agregar_persona_relacionada_model.dart';
export 'agregar_persona_relacionada_model.dart';
...
class AgregarPersonaRelacionadaWidget extends StatefulWidget {
  ...
  State<AgregarPersonaRelacionadaWidget> createState() =>
      _AgregarPersonaRelacionadaWidgetState();
}

class _AgregarPersonaRelacionadaWidgetState
    extends State<AgregarPersonaRelacionadaWidget> {
  late AgregarPersonaRelacionadaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarPersonaRelacionadaModel());
                                ...
                                onPressed: () async {
                                  await Seccion8Table().insert({
                                    ...
                                    'Vinculo': _model.dropDownValue != 'Otros'
                                        ...
                                        : _model.textController6.text,
                                    'entrevistado': false,
                                    'ocupacion': _model.textController7.text,
                                    'refdeubicacion':
