...
import 'grupoconvivientepagina_model.dart';
export 'grupoconvivientepagina_model.dart';

class GrupoconvivientepaginaWidget extends StatefulWidget {
  const GrupoconvivientepaginaWidget({
    super.key,
    this.idingreso,
    this.idexpediente,
    this.idseccion1,
  ...
  static String routeName = 'grupoconvivientepagina';
  static String routePath = '/grupoconvivientepagina';

  @override
  State<GrupoconvivientepaginaWidget> createState() =>
      _GrupoconvivientepaginaWidgetState();
}

class _GrupoconvivientepaginaWidgetState
    extends State<GrupoconvivientepaginaWidget> {
  late GrupoconvivientepaginaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GrupoconvivientepaginaModel());
                  ...
                  child: FutureBuilder<List<GrupoConvivienteRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<GrupoConvivienteRow>
                          containerGrupoConvivienteRowList = snapshot.data!;
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(),
                                                child: Text(
                                                  '3. Grupo conviviente y no conviviente',
