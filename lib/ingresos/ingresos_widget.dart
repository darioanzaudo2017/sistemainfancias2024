                                                              ...
                                                              FutureBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  List<ImpresionesExpedientesRow>
                                                                      buttonImpresionesExpedientesRowList =
                                                                      snapshot
                                                                          .data!;

                                                                  final buttonImpresionesExpedientesRow = buttonImpresionesExpedientesRowList
                                                                          .isNotEmpty
                                                                      ? buttonImpresionesExpedientesRowList
                                                                          .first
                                                                      : null;
                                                                  ...
                                                                  return FFButtonWidget(
                                                                    onPressed:
                                                                        () async {
                                                                      await launchURL(
                                                                          buttonImpresionesExpedientesRow!
                                                                              .linkcarpeta!);
                                                                    },
                                                                    text:
                                                                        'Link carpeta expediente',
                                                                    options:
                                                                        FFButtonOptions(
                                                                      height:
                                                                          35.0,
