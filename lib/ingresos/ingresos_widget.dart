                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    if (ingresosVistaIngresosDiasRowList.where((e) => e.estado == 'Abierto').toList().length >
                                                                            0
                                                                        ? false
                                                                        : true)
                                                                      FFButtonWidget(
                                                                        onPressed:
                                                                            () async {
                                                                          _model.caprtetaexp =
                                                                              await ImpresionesExpedientesTable().queryRows(
                                                                            queryFn: (q) =>
                                                                                q.eqOrNull(
                                                                              'idexpediente',
                                                                              widget.idexp,
                                                                          ...
                                                                          await IngresosTable()
                                                                              .update(
                                                                            data: {
                                                                              'listadoimpresiones': true,
                                                                            },
                                                                            matchingRows: (rows) =>
                                                                                rows.eqOrNull(
                                                                              'id',
                                                                              _model.crearingreso?.id,
                                                                            ),
                                                                          );
                                                                          safeSetState(() =>
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Builder(
                                                                              builder: (context) {
                                                                                final containerVar = ingresosVistaIngresosDiasRowList.toList();
