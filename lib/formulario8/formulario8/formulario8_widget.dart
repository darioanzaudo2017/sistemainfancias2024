...
import 'formulario8_model.dart';
export 'formulario8_model.dart';

class Formulario8Widget extends StatefulWidget {
  const Formulario8Widget({
    super.key,
  ...
  @override
  State<Formulario8Widget> createState() => _Formulario8WidgetState();
}

class _Formulario8WidgetState extends State<Formulario8Widget> {
  late Formulario8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Formulario8Model());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Descripción de la nueva medida',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Noto Sans JP',
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText:
                                    'Especificar en caso de \"otorga otro recurso\"',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Noto Sans JP',
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText:
                                    'Plazo en caso de \"otorga otro recurso\"',
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Noto Sans JP',
