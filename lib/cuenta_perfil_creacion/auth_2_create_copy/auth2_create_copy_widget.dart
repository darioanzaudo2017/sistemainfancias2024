...
import 'auth2_create_copy_model.dart';
export 'auth2_create_copy_model.dart';

class Auth2CreateCopyWidget extends StatefulWidget {
  const Auth2CreateCopyWidget({
    super.key,
    this.idrol,
  });
  ...
  static String routeName = 'auth_2_CreateCopy';
  static String routePath = '/auth2CreateCopy';

  @override
  State<Auth2CreateCopyWidget> createState() => _Auth2CreateCopyWidgetState();
}

class _Auth2CreateCopyWidgetState extends State<Auth2CreateCopyWidget>
    with TickerProviderStateMixin {
  late Auth2CreateCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Auth2CreateCopyModel());
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.apiResultqth =
                                          await CrearusuarioCall.call(
                                        mail: _model
                                            .emailAddressTextController.text,
                                        nombre: _model
                                            .nombreCompletoTextController.text,
                                        spd: _model.dropDownValue1,
                                        zona: _model.dropDownValue2,
                                        token: currentJwtToken,
                                        pass:
                                            _model.passwordTextController.text,
                                      );

                                      if ((_model.apiResultqth?.succeeded ??
                                          true)) {
