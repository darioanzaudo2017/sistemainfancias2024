                                                                                                              ...
                                                                                                              if (containerform9Formulario9Row?.idForm9 == null) {
                                                                                                                ...
                                                                                                                if (_model.form9?.causa == 'Solicitud de medida excepcional al organismo provincial de protección de derechos (SENAF)') {
                                                                                                                  ...
                                                                                                                  await ResendSupabaseCall.call(
                                                                                                                    ...
                                                                                                                    mensaje: 'Hay una nueva solicitud de medida excepcionalExpediente: ${stackVistaExpedientesUltimoEstadoRow?.expediente}/ NNyA: ${stackVistaExpedientesUltimoEstadoRow?.nombre}, ${stackVistaExpedientesUltimoEstadoRow?.apellido}/ DNI: ${stackVistaExpedientesUltimoEstadoRow?.DNI?.toString()}',
