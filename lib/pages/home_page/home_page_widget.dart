...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.contexto = await InfoDeContextoCall.call(
      ...
      _model.apiResult88v1 = await SearchExpedientesPageCall.call(
        ...
        pLimit: 20,
        pOffset: 0,
        pQ: _model.textFieldTextController.text,
      );

      if ((_model.apiResult88v1?.succeeded ?? true)) {
        FFAppState().listaexpedientespage =
            ListaexoedientespageStruct.maybeFromMap(
                (_model.apiResult88v1?.jsonBody ?? ''))!;
        safeSetState(() {});
      }
    });
                            ...
                            Align(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  ContextoinicialStruct.maybeFromMap(
                                          (_model.contexto?.jsonBody ?? ''))
                                      ?.usuario
                                      .nombre,
                                  'Sin dato',
                                ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        spd: ContextoinicialStruct.maybeFromMap((_model.contexto?.jsonBody ??
                                                                                ''))
                                                                            ?.usuario
                                                                            .spd,
                                                                        idusuario:
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        16.0, 0.0, 0.0, 5.0),
                                                child: Text(
                                                  'Email: ${ContextoinicialStruct.maybeFromMap((_model.contexto?.jsonBody ?? ''))?.usuario.nombre}',
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        16.0, 0.0, 0.0, 5.0),
                                                child: Text(
                                                  'Zona: ${ContextoinicialStruct.maybeFromMap((_model.contexto?.jsonBody ?? ''))?.usuario.zona.toString()}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        16.0, 0.0, 0.0, 5.0),
                                                child: Text(
                                                  'SPD: ${ContextoinicialStruct.maybeFromMap((_model.contexto?.jsonBody ?? ''))?.usuario.spd}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            ContextoinicialStruct.maybeFromMap((_model.contexto?.jsonBody ?? ''))?.homeKpis.ingresosTotales.toString(),
                                                                            '0',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .displaySmall
                                              ...
                                              Padding(
                                                ...
                                                child: wrapWithModel(
                                                  model:
                                                      _model.referenciasModel,
                                                  updateCallback: () =>
                                                      safeSetState(() {}),
                                                  child: ReferenciasWidget(),
                                                ),
                                              ),
                                            ],
                                          ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            FFButtonWidget(
                                              onPressed: () async {
                                                _model.apiResult88v =
                                                    await SearchExpedientesPageCall
                                                        .call(
                                                  token: currentJwtToken,
                                                  pLimit: 20,
                                                  pOffset: 0,
                                                ...
                                                if ((_model.apiResult88v
                                                        ?.succeeded ??
                                                    true)) {
                                                  FFAppState()
                                                          .listaexpedientespage =
