...
class Formulario5HistorialTable extends SupabaseTable<Formulario5HistorialRow> {
  @override
  String get tableName => 'Formulario5_Historial';

  @override
  Formulario5HistorialRow createRow(Map<String, dynamic> data) =>
      Formulario5HistorialRow(data);
}
