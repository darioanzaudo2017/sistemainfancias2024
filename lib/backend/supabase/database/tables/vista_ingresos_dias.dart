...
class VistaIngresosDiasTable extends SupabaseTable<VistaIngresosDiasRow> {
  @override
  String get tableName => 'vista_ingresos_dias';

  @override
  VistaIngresosDiasRow createRow(Map<String, dynamic> data) =>
      VistaIngresosDiasRow(data);
}
...
class VistaIngresosDiasRow extends SupabaseDataRow {
  ...
  double? get diasActualizacion => getField<double>('dias_actualizacion');
  set diasActualizacion(double? value) =>
      setField<double>('dias_actualizacion', value);

  double? get diasCierre => getField<double>('dias_cierre');
  set diasCierre(double? value) => setField<double>('dias_cierre', value);
}
