...
class VistaExpedientesUltimoEstadoTodosTable
    extends SupabaseTable<VistaExpedientesUltimoEstadoTodosRow> {
  @override
  String get tableName => 'vista_expedientes_ultimo_estado_todos';

  @override
  VistaExpedientesUltimoEstadoTodosRow createRow(Map<String, dynamic> data) =>
      VistaExpedientesUltimoEstadoTodosRow(data);
}

class VistaExpedientesUltimoEstadoTodosRow extends SupabaseDataRow {
  VistaExpedientesUltimoEstadoTodosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VistaExpedientesUltimoEstadoTodosTable();
