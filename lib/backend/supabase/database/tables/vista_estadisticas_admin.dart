...
class VistaEstadisticasAdminTable
    extends SupabaseTable<VistaEstadisticasAdminRow> {
  @override
  String get tableName => 'vista_estadisticas_admin';

  @override
  VistaEstadisticasAdminRow createRow(Map<String, dynamic> data) =>
      VistaEstadisticasAdminRow(data);
}

class VistaEstadisticasAdminRow extends SupabaseDataRow {
  VistaEstadisticasAdminRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VistaEstadisticasAdminTable();
