...
class VistaExpedientesSenafTable
    extends SupabaseTable<VistaExpedientesSenafRow> {
  @override
  String get tableName => 'vista_expedientes_senaf';

  @override
  VistaExpedientesSenafRow createRow(Map<String, dynamic> data) =>
      VistaExpedientesSenafRow(data);
}
...
class VistaExpedientesSenafRow extends SupabaseDataRow {
  ...
  int? get diasDiferencia => getField<int>('dias_diferencia');
  set diasDiferencia(int? value) => setField<int>('dias_diferencia', value);
}
