...
class GrupoConvivienteCeseListStruct extends BaseStruct {
  ...
  static GrupoConvivienteCeseListStruct fromMap(Map<String, dynamic> data) =>
      GrupoConvivienteCeseListStruct(
  ...
  static GrupoConvivienteCeseListStruct? maybeFromMap(dynamic data) =>
      data is Map
          ? GrupoConvivienteCeseListStruct.fromMap(data.cast<String, dynamic>())
          : null;
  ...
  static GrupoConvivienteCeseListStruct fromSerializableMap(
  ...
  @override
  String toString() => 'GrupoConvivienteCeseListStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is GrupoConvivienteCeseListStruct &&
        id == other.id &&
        nombre == other.nombre &&
...
GrupoConvivienteCeseListStruct createGrupoConvivienteCeseListStruct({
  int? id,
  String? nombre,
  String? apellido,
  String? vinculo,
