...
class IngresoDataStruct extends BaseStruct {
  IngresoDataStruct({
    int? id,
    String? createdAt,
    bool? form1,
  ...
  static IngresoDataStruct fromMap(Map<String, dynamic> data) =>
      IngresoDataStruct(
  ...
  static IngresoDataStruct? maybeFromMap(dynamic data) => data is Map
      ? IngresoDataStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static IngresoDataStruct fromSerializableMap(Map<String, dynamic> data) =>
      IngresoDataStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'IngresoDataStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is IngresoDataStruct &&
        id == other.id &&
...
IngresoDataStruct createIngresoDataStruct({
  int? id,
  String? createdAt,
  bool? form1,
  bool? ampliacion,
