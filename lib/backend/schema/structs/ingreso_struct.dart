...
class IngresoStruct extends BaseStruct {
  IngresoStruct({
    int? id,
    bool? form1,
    bool? form3,
  ...
  static IngresoStruct fromMap(Map<String, dynamic> data) => IngresoStruct(
  ...
  static IngresoStruct? maybeFromMap(dynamic data) =>
      data is Map ? IngresoStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static IngresoStruct fromSerializableMap(Map<String, dynamic> data) =>
      IngresoStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'IngresoStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is IngresoStruct &&
        id == other.id &&
        form1 == other.form1 &&
        form3 == other.form3 &&
        form4 == other.form4 &&
...
IngresoStruct createIngresoStruct({
  int? id,
  bool? form1,
  bool? form3,
  bool? form4,
