...
class PerfilExpedienteStruct extends BaseStruct {
  PerfilExpedienteStruct({
    int? id,
    String? expediente,
    String? fecha,
    String? nombres,
  ...
  static PerfilExpedienteStruct fromMap(Map<String, dynamic> data) =>
      PerfilExpedienteStruct(
  ...
  static PerfilExpedienteStruct? maybeFromMap(dynamic data) => data is Map
      ? PerfilExpedienteStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PerfilExpedienteStruct fromSerializableMap(
  ...
  @override
  String toString() => 'PerfilExpedienteStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PerfilExpedienteStruct &&
        id == other.id &&
...
PerfilExpedienteStruct createPerfilExpedienteStruct({
  int? id,
  String? expediente,
  String? fecha,
  String? nombres,
