...
class ExpedienteDataStruct extends BaseStruct {
  ExpedienteDataStruct({
    int? id,
    String? expediente,
    String? fecha,
    String? nombres,
  ...
  static ExpedienteDataStruct fromMap(Map<String, dynamic> data) =>
      ExpedienteDataStruct(
  ...
  static ExpedienteDataStruct? maybeFromMap(dynamic data) => data is Map
      ? ExpedienteDataStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ExpedienteDataStruct fromSerializableMap(Map<String, dynamic> data) =>
      ExpedienteDataStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'ExpedienteDataStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ExpedienteDataStruct &&
        id == other.id &&
...
ExpedienteDataStruct createExpedienteDataStruct({
  int? id,
  String? expediente,
  String? fecha,
  String? nombres,
