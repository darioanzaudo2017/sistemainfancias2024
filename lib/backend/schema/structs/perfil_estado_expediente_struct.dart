...
class PerfilEstadoExpedienteStruct extends BaseStruct {
  PerfilEstadoExpedienteStruct({
    int? id,
    String? expediente,
    String? fecha,
    String? nombres,
  ...
  static PerfilEstadoExpedienteStruct fromMap(Map<String, dynamic> data) =>
      PerfilEstadoExpedienteStruct(
  ...
  static PerfilEstadoExpedienteStruct? maybeFromMap(dynamic data) => data is Map
      ? PerfilEstadoExpedienteStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PerfilEstadoExpedienteStruct fromSerializableMap(
  ...
  @override
  String toString() => 'PerfilEstadoExpedienteStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PerfilEstadoExpedienteStruct &&
        id == other.id &&
...
PerfilEstadoExpedienteStruct createPerfilEstadoExpedienteStruct({
  int? id,
  String? expediente,
  String? fecha,
  String? nombres,
