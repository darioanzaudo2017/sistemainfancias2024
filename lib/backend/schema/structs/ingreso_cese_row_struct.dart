...
class IngresoCeseRowStruct extends BaseStruct {
  IngresoCeseRowStruct({
    int? id,
    String? createdAt,
    bool? form1,
    bool? ampliacion,
  ...
  static IngresoCeseRowStruct fromMap(Map<String, dynamic> data) =>
      IngresoCeseRowStruct(
  ...
  static IngresoCeseRowStruct? maybeFromMap(dynamic data) => data is Map
      ? IngresoCeseRowStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static IngresoCeseRowStruct fromSerializableMap(Map<String, dynamic> data) =>
      IngresoCeseRowStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'IngresoCeseRowStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is IngresoCeseRowStruct &&
        id == other.id &&
...
IngresoCeseRowStruct createIngresoCeseRowStruct({
  int? id,
  String? createdAt,
  bool? form1,
  bool? ampliacion,
