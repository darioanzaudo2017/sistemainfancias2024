...
class DerechosListStruct extends BaseStruct {
  DerechosListStruct({
    int? id,
    String? createdAt,
    String? derecho,
  ...
  static DerechosListStruct fromMap(Map<String, dynamic> data) =>
      DerechosListStruct(
  ...
  static DerechosListStruct? maybeFromMap(dynamic data) => data is Map
      ? DerechosListStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DerechosListStruct fromSerializableMap(Map<String, dynamic> data) =>
      DerechosListStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'DerechosListStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DerechosListStruct &&
        id == other.id &&
...
DerechosListStruct createDerechosListStruct({
  int? id,
  String? createdAt,
  String? derecho,
  String? subcategoria,
