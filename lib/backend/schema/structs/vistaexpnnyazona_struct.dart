...
class VistaexpnnyazonaStruct extends BaseStruct {
  VistaexpnnyazonaStruct({
    int? id,
    String? expediente,
    String? fecha,
    String? nombres,
  ...
  // "zona" field.
  ZonaStruct? _zona;
  ZonaStruct get zona => _zona ?? ZonaStruct();
  set zona(ZonaStruct? val) => _zona = val;

  void updateZona(Function(ZonaStruct) updateFn) {
    updateFn(_zona ??= ZonaStruct());
  }
  ...
  static VistaexpnnyazonaStruct fromMap(Map<String, dynamic> data) =>
      VistaexpnnyazonaStruct(
        ...
        zona: data['zona'] is ZonaStruct
            ? data['zona']
            : ZonaStruct.maybeFromMap(data['zona']),
        nNyA: data['NNyA'] is NNyAStruct
            ? data['NNyA']
            : NNyAStruct.maybeFromMap(data['NNyA']),
      );

  static VistaexpnnyazonaStruct? maybeFromMap(dynamic data) => data is Map
      ? VistaexpnnyazonaStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static VistaexpnnyazonaStruct fromSerializableMap(
      ...
      VistaexpnnyazonaStruct(
        ...
        zona: deserializeStructParam(
          data['zona'],
          ParamType.DataStruct,
          false,
          structBuilder: ZonaStruct.fromSerializableMap,
        ),
  ...
  @override
  String toString() => 'VistaexpnnyazonaStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is VistaexpnnyazonaStruct &&
        id == other.id &&
...
VistaexpnnyazonaStruct createVistaexpnnyazonaStruct({
  int? id,
  String? expediente,
  String? fecha,
  String? nombres,
