...
class PerfilIngresoStruct extends BaseStruct {
  PerfilIngresoStruct({
    int? id,
    String? createdAt,
    bool? form1,
  ...
  static PerfilIngresoStruct fromMap(Map<String, dynamic> data) =>
      PerfilIngresoStruct(
  ...
  static PerfilIngresoStruct? maybeFromMap(dynamic data) => data is Map
      ? PerfilIngresoStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PerfilIngresoStruct fromSerializableMap(Map<String, dynamic> data) =>
      PerfilIngresoStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'PerfilIngresoStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PerfilIngresoStruct &&
        id == other.id &&
...
PerfilIngresoStruct createPerfilIngresoStruct({
  int? id,
  String? createdAt,
  bool? form1,
  bool? ampliacion,
