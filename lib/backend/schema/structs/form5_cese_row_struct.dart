...
class Form5CeseRowStruct extends BaseStruct {
  Form5CeseRowStruct({
    int? id,
    String? fecha,
  ...
  // "fundamento" field.
  String? _fundamento;
  String get fundamento => _fundamento ?? '';
  set fundamento(String? val) => _fundamento = val;

  bool hasFundamento() => _fundamento != null;

  // "indicadores" field.
  String? _indicadores;
  String get indicadores => _indicadores ?? '';
  set indicadores(String? val) => _indicadores = val;

  bool hasIndicadores() => _indicadores != null;
  ...
  static Form5CeseRowStruct fromMap(Map<String, dynamic> data) =>
      Form5CeseRowStruct(
        id: castToType<int>(data['id']),
        fecha: data['fecha'] as String?,
        profesionales: data['profesionales'] as String?,
        fundamento: data['fundamento'] as String?,
        indicadores: data['indicadores'] as String?,
  ...
  static Form5CeseRowStruct? maybeFromMap(dynamic data) => data is Map
      ? Form5CeseRowStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  Map<String, dynamic> toSerializableMap() => {
        ...
        'fundamento': serializeParam(
          _fundamento,
          ParamType.String,
        ),
        'indicadores': serializeParam(
          _indicadores,
          ParamType.String,
        ),
  ...
  static Form5CeseRowStruct fromSerializableMap(Map<String, dynamic> data) =>
      Form5CeseRowStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
        ...
        fundamento: deserializeParam(
          data['fundamento'],
          ParamType.String,
          false,
        ),
        indicadores: deserializeParam(
          data['indicadores'],
          ParamType.String,
          false,
        ),
  ...
  @override
  String toString() => 'Form5CeseRowStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is Form5CeseRowStruct &&
        id == other.id &&
        fecha == other.fecha &&
...
Form5CeseRowStruct createForm5CeseRowStruct({
  int? id,
  String? fecha,
  String? profesionales,
  String? fundamento,
