...
class ExpedienteCeseRowStruct extends BaseStruct {
  ExpedienteCeseRowStruct({
    int? id,
    String? expediente,
    String? fecha,
    String? nombres,
  ...
  static ExpedienteCeseRowStruct fromMap(Map<String, dynamic> data) =>
      ExpedienteCeseRowStruct(
  ...
  static ExpedienteCeseRowStruct? maybeFromMap(dynamic data) => data is Map
      ? ExpedienteCeseRowStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ExpedienteCeseRowStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ExpedienteCeseRowStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ExpedienteCeseRowStruct &&
        id == other.id &&
...
ExpedienteCeseRowStruct createExpedienteCeseRowStruct({
  int? id,
  String? expediente,
  String? fecha,
  String? nombres,
