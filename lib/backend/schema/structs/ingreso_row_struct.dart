...
class IngresoRowStruct extends BaseStruct {
  IngresoRowStruct({
    int? id,
    String? createdAt,
    bool? form1,
  ...
  static IngresoRowStruct fromMap(Map<String, dynamic> data) =>
      IngresoRowStruct(
  ...
  static IngresoRowStruct? maybeFromMap(dynamic data) => data is Map
      ? IngresoRowStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static IngresoRowStruct fromSerializableMap(Map<String, dynamic> data) =>
      IngresoRowStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  @override
  String toString() => 'IngresoRowStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is IngresoRowStruct &&
        id == other.id &&
...
IngresoRowStruct createIngresoRowStruct({
  int? id,
  String? createdAt,
  bool? form1,
  bool? ampliacion,
