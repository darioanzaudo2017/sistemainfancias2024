                      ...
                      child: Padding(
                        ...
                        child: FutureBuilder<List<SpdRow>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<SpdRow> columnSpdRowList = snapshot.data!;

                            final columnSpdRow = columnSpdRowList.isNotEmpty
                                ? columnSpdRowList.first
                                : null;
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                            .textFieldmotivoTextController3 ??=
                                        TextEditingController(
                                      text: formVistaExpedientesUltimoEstadoRow
                                          ?.DNI
                                          ?.toString(),
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.apiResulth1aavisoentreNNyA =
                                            await AvisoConvocatoriaAlNNyACall
                                                .call(
                                          ...
                                          direccionCPC: columnSpdRow?.direccion,
                                          idampliacion:
                                              widget.idampliacion?.toString(),
                                          telefonoCPC: columnSpdRow?.telefono,
                                        );
