              ...
              FutureBuilder<List<VistaExpedientesUltimoEstadoRow>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<VistaExpedientesUltimoEstadoRow>
                      rowVistaExpedientesUltimoEstadoRowList = snapshot.data!;

                  final rowVistaExpedientesUltimoEstadoRow =
                      rowVistaExpedientesUltimoEstadoRowList.isNotEmpty
                          ? rowVistaExpedientesUltimoEstadoRowList.first
                          : null;
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return WebViewAware(
                                                                        child:
                                                                            AlertDialog(
                                                                          title:
                                                                              Text('Copiar lista de medidas'),
                                                                          content:
                                                                              Text('Estas por copiar la lista de medidas del NNyA principal'),
                                                                          actions: [
                                                                            TextButton(
                                                                  ...
                                                                  return FlutterFlowDataTable<
                                                                    ...
                                                                    dataRowBuilder: (listdefiniciondemedidasItem,
                                                                      ...
                                                                      color: WidgetStateProperty
                                                                          .all(
                                                                        listdefiniciondemedidasIndex % 2 ==
                                                                                0
                                                                      ...
                                                                      cells: [
                                                                        ...
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              listdefiniciondemedidasItem.descripcionDeAcciones,
                                                                              'Sin dato',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.notoSansJp(
                                                                        ...
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            valueOrDefault<String>(
                                                                              listdefiniciondemedidasItem.responsables,
                                                                              'Sin dato',
                                                                            ),
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.notoSansJp(
                                                                        ...
                                                                        FutureBuilder<
                                                                          ...
                                                                          future:
                                                                              ListaDerechosVulneradosexpedienteTable().querySingleRow(
                                                                            queryFn: (q) =>
                                                                                q.eqOrNull(
                                                                              'id',
                                                                              listdefiniciondemedidasItem.idlistaderechos,
                                                                            ),
                                                                          ),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                                          ...
                                                                                          child: FFButtonWidget(
                                                                                            onPressed: () async {
                                                                                              _model.form7 = await Formulario7Table().insert({
                                                                                                'nombres': rowVistaExpedientesUltimoEstadoRow?.nombre,
                                                                                                'apellidos': rowVistaExpedientesUltimoEstadoRow?.apellido,
                                                                                                'dni': rowVistaExpedientesUltimoEstadoRow?.DNI?.toString(),
                                                                                              });
                                                                                              await showModalBottomSheet(
                                                                                                isScrollControlled: true,
                                                                                                backgroundColor: Colors.transparent,
