...
import 'adjuntardocumentoampliacion_model.dart';
export 'adjuntardocumentoampliacion_model.dart';
...
class AdjuntardocumentoampliacionWidget extends StatefulWidget {
  ...
  State<AdjuntardocumentoampliacionWidget> createState() =>
      _AdjuntardocumentoampliacionWidgetState();
}

class _AdjuntardocumentoampliacionWidgetState
    extends State<AdjuntardocumentoampliacionWidget> {
  late AdjuntardocumentoampliacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdjuntardocumentoampliacionModel());
          ...
          child: Column(
            ...
            children: [
              ...
              FlutterFlowDropDown<String>(
                ...
                hintText: 'Seleccionar tipo de adjunto',
                icon: Icon(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (selectedFiles != null) {
                        safeSetState(() => _model
                            .isDataUploading_uploadData9zvampliacion = true);
                        ...
                        try {
                          ...
                          _model.isDataUploading_uploadData9zvampliacion =
                              false;
                        }
                        if (selectedUploadedFiles.length ==
                          ...
                          safeSetState(() {
                            _model.uploadedLocalFile_uploadData9zvampliacion =
