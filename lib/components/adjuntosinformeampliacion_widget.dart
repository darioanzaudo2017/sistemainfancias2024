...
import '/components/adjuntardocumentoampliacion_widget.dart';
...
import 'adjuntosinformeampliacion_model.dart';
export 'adjuntosinformeampliacion_model.dart';
...
class AdjuntosinformeampliacionWidget extends StatefulWidget {
  ...
  State<AdjuntosinformeampliacionWidget> createState() =>
      _AdjuntosinformeampliacionWidgetState();
}

class _AdjuntosinformeampliacionWidgetState
    extends State<AdjuntosinformeampliacionWidget> {
  late AdjuntosinformeampliacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdjuntosinformeampliacionModel());
                  ...
                  child: Builder(
                    builder: (context) {
                      ...
                      return FlutterFlowDataTable<DocumentosadjuntosRow>(
                        ...
                        dataRowBuilder: (listaadjuntosItem, listaadjuntosIndex,
                          ...
                          cells: [
                            ...
                            Align(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  await launchURL(
                                      listaadjuntosItem.documentopdf!);
                                },
                              ),
                            ),
                            Text(
