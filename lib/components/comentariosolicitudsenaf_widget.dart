...
import 'comentariosolicitudsenaf_model.dart';
export 'comentariosolicitudsenaf_model.dart';

class ComentariosolicitudsenafWidget extends StatefulWidget {
  ...
  State<ComentariosolicitudsenafWidget> createState() =>
      _ComentariosolicitudsenafWidgetState();
}

class _ComentariosolicitudsenafWidgetState
    extends State<ComentariosolicitudsenafWidget> {
  late ComentariosolicitudsenafModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComentariosolicitudsenafModel());
