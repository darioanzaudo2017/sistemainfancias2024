...
class _TarjetaencabezadoWidgetState extends State<TarjetaencabezadoWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<VistaExpedientesUltimoEstadoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VistaExpedientesUltimoEstadoRow>
            cardVistaExpedientesUltimoEstadoRowList = snapshot.data!;

        final cardVistaExpedientesUltimoEstadoRow =
            cardVistaExpedientesUltimoEstadoRowList.isNotEmpty
                ? cardVistaExpedientesUltimoEstadoRowList.first
                : null;
        ...
        return Card(
          ...
          child: FutureBuilder<List<VistaUsuariosRolesRow>>(
            future: FFAppState().usuariosroles(
              requestFn: () => VistaUsuariosRolesTable().querySingleRow(
                queryFn: (q) => q.eqOrNull(
                  'id',
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                'NNyA: ${cardVistaExpedientesUltimoEstadoRow?.nombre}  ${cardVistaExpedientesUltimoEstadoRow?.apellidos}',
                                                style:
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        valueOrDefault<String>(
                                                          cardVistaExpedientesUltimoEstadoRow
                                                              ?.DNI
                                                              ?.toString(),
                                                          'Sin dato',
                                                        ),
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Flex(
                                                            ...
                                                            children: [
                                                              ...
                                                              Visibility(
                                                                visible: listViewVistaNnyaexpgruRow
                                                                        .idExpediente !=
                                                                    cardVistaExpedientesUltimoEstadoRow
                                                                        ?.id,
                                                                child:
