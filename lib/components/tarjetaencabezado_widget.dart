  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final containerTarjetaexpedienteResponse = snapshot.data!;
                            ...
                            Row(
                              ...
                              children: [
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            8.0, 0.0, 8.0, 0.0),
                                        child: Text(
                                          'NNyA: ${TarjetaexpedienteStruct.maybeFromMap(containerTarjetaexpedienteResponse.jsonBody)?.nnya.nombre}, ${TarjetaexpedienteStruct.maybeFromMap(containerTarjetaexpedienteResponse.jsonBody)?.nnya.apellido}',
                                                ...
                                                Text(
                                                  valueOrDefault<String>(
                                                    TarjetaexpedienteStruct
                                                            .maybeFromMap(
                                                                containerTarjetaexpedienteResponse
                                                                    .jsonBody)
                                                        ?.nnya
                                                        .dni
                                                        .toString(),
                                ...
                                FFButtonWidget(
                                        ...
                                        return WebViewAware(
                                          child: Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child:
                                                ListaexpedientesrelacionadosWidget(
                                              idexpedientepropio:
                                                  widget.idexpediente,
                                              idnnya: TarjetaexpedienteStruct
                                                      .maybeFromMap(
                                                          containerTarjetaexpedienteResponse
                                                              .jsonBody)
                                                  ?.nnya
                                  ...
                                  text: 'Ver exp. donde aparece NNyA',
