              ...
              child: FutureBuilder<List<AnexoinstitucionesaludRow>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<AnexoinstitucionesaludRow>
                      listViewAnexoinstitucionesaludRowList = snapshot.data!;
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, listViewIndex) {
                      final listViewAnexoinstitucionesaludRow =
                          listViewAnexoinstitucionesaludRowList[listViewIndex];
                      return Padding(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (listViewAnexoinstitucionesaludRow.linkdoc !=
                                        null &&
                                    listViewAnexoinstitucionesaludRow.linkdoc !=
                                        '')
                                  FFButtonWidget(
                                    onPressed: () async {
                                      await launchURL(
