              ...
              child: FutureBuilder<List<VistaExpedientesUltimoEstadoRow>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<VistaExpedientesUltimoEstadoRow>
                      formVistaExpedientesUltimoEstadoRowList = snapshot.data!;

                  final formVistaExpedientesUltimoEstadoRow =
                      formVistaExpedientesUltimoEstadoRowList.isNotEmpty
                          ? formVistaExpedientesUltimoEstadoRowList.first
                          : null;
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model.textController1 ??=
                                            ...
                                            text:
                                                formVistaExpedientesUltimoEstadoRow
                                                    ?.nombre,
                                          ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Text(
                                        'Agregar personas intervinientes del acta',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              font: GoogleFonts.notoSansJp(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              await ListaPersonasActaTable()
                                                  .insert({
                                                'Nombres':
                                                    _model.textController4.text,
                                                'Apellidos':
                                                    _model.textController5.text,
                                                'Dni': double.tryParse(_model
                                                    .textController6.text),
                                                'idform7': widget.idform7,
                                              });
                                              safeSetState(() => _model
                                    ...
                                    FutureBuilder<List<ListaPersonasActaRow>>(
                                      future: (_model.requestCompleter ??=
                                              Completer<
                                                  List<ListaPersonasActaRow>>()
                                                ..complete(
                                                    ListaPersonasActaTable()
                                                        .queryRows(
                                                  queryFn: (q) => q.eqOrNull(
                                                    'idform7',
                                                    widget.idform7,
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ListaPersonasActaRow>
                                            listViewListaPersonasActaRowList =
                                            snapshot.data!;
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewListaPersonasActaRow =
                                                listViewListaPersonasActaRowList[
                                                    listViewIndex];
                                            return Container(
                                              width: 100.0,
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.textController12 ??=
                                      TextEditingController(
                                    text: formVistaExpedientesUltimoEstadoRow
                                        ?.spd,
                                  ),
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await ListadeactasTable().insert({
                                            'fecha': supaSerialize<DateTime>(
                                                getCurrentTimestamp),
